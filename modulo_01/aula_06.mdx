...
- **Variáveis:** Armazenam dados que podem ser usados e modificados pelas funções do contrato.
- **Funções:** Executam ações específicas e podem modificar o estado do contrato.
- **Modificadores:** Alteram o comportamento de funções, adicionando condições ou restrições.
